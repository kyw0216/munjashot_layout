...
}( this, function( )
{
        ...
        if ( ! function( e, n )
            {
                m( e.classList )
                    .forEach( function( t )
                    {
                        -1 === f( z )
                            .indexOf( t ) && -1 === f( W )
                            .indexOf( t ) && -1 === f( n.showClass )
                            .indexOf( t ) && e.classList.remove( t )
                    } )
            }( t, e ), e.customClass && e.customClass[ n ] )
        {
            if ( "string" != typeof e.customClass[ n ] && !e.customClass[ n ].forEach ) return D( "Invalid type of customClass.".concat( n, '! Expected string or iterable object, got "' )
    ...
    var ct, ut = function( t, e )
        ...
        pt = '\n <div aria-labelledby="'.concat( z.title, '" aria-describedby="' )
    ...
    {
        var n = Z( P( ), "checkbox" );
        return n.value = 1, n.id = z.checkbox, n.checked = Boolean( e.inputValue ), t.querySelector( "span" )
            .innerHTML = e.inputPlaceholder, t
    }, At.textarea = function( e, t )
    {
        if ( e.value = t.inputValue, bt( e, t ), "MutationObserver" in window )
        {
            var n = parseInt( window.getComputedStyle( C( ) )
                    .width ),
                o = parseInt( window.getComputedStyle( C( ) )
                    .paddingLeft ) + parseInt( window.getComputedStyle( C( ) )
                    .paddingRight );
    ...
    {
        var n = P( )
            .querySelector( "#".concat( z.content ) );
    ...
    var Ot = function( )
        ...
        Mt = function( )
        {
            for ( var t = C( ), e = window.getComputedStyle( t )
        ...
        jt = function( t )
        {
            return '<div class="'.concat( z[ "icon-content" ], '">' )
                .concat( t, "</div>" )
        };
    ...
    var Ut = [ ],
        ...
        Yt = Object.freeze(
        {
            ...
            argsToParams: function( o )
            {
                ...
                {
                    var n = o[ e ];
                    "string" == typeof n || b( n ) ? i[ t ] = n : void 0 !== n && h( "Unexpected type of ".concat( t, '! Expected "string" or "Element", got ' )
                        .concat( r( n ) ) )
                } ) : c( i, o[ 0 ] ), i
            },
            isVisible: function( )
            ...
            mixin: function( n )
            {
                return function( t )
                {
                    ...
                    }( e, t ), a( e, [
                    {
                        ...
                        value: function( t )
                        {
                            return p( u( e.prototype ), "_main", this )
                                .call( this, c(
                                {}, n, t ) )
                        }
                    } ] ), e
            ...
            queue: function( t )
            {
                ...
                return new Promise( function( i )
                {
                    ! function e( n, o )
                    {
                        n < Ut.length ? ( document.body.setAttribute( "data-swal2-queue-step", n ), r.fire( Ut[ n ] )
                            .then( function( t )
                            {
    ...
    function Qt( )
    {
        null === Y.previousBodyPadding && document.body.scrollHeight > window.innerHeight && ( Y.previousBodyPadding = parseInt( window.getComputedStyle( document.body )
            .getPropertyValue( "padding-right" ) ), document.body.style.paddingRight = "".concat( Y.previousBodyPadding + function( )
        {
            var t = document.createElement( "div" );
    ...
    function te( t, e, n, o )
    {
        n ? ie( t, o ) : ( It( )
            ...
            }( ), "undefined" != typeof window && $t( ) && window.removeEventListener( "resize", Jt ), m( document.body.children )
            .forEach( function( t )
            {
    ...
    function se( t )
    {
        ! function( e )
        {
            e.inputValidator || Object.keys( ue )
                .forEach( function( t )
                {
    ...
    var ye = function( t, e )
        ...
        we = function( t, e )
        {
            ...
            }( ), "undefined" != typeof window && $t( ) && ( Jt( ), window.addEventListener( "resize", Jt ) ), m( document.body.children )
                .forEach( function( t )
                {
                    t === y( ) || function( t, e )
                    {
        ...
        Te = function( e, n )
        {
            ...
            n.inputValidator ? ( e.disableInput( ), Promise.resolve( )
                ...
                .checkValidity( ) ? Le( e, n, o ) : ( e.enableButtons( ), e.showValidationMessage( n.validationMessage ) )
        },
        Le = function( e, t, n )
        {
            ( t.showLoaderOnConfirm && Vt( ), t.preConfirm ) ? ( e.resetValidationMessage( ), Promise.resolve( )
                .then( function( )
                {
    ...
    var Ke, Ye = Object.freeze(
    {
        ...
        _main: function( t )
        {
            ...
            {
                var e = c(
                    {}, _t.showClass, t.showClass ),
                    n = c(
                    {}, _t.hideClass, t.hideClass ),
                    o = c(
                    {}, _t, t );
    ...
    Ze.prototype.then = function( t )
        {
            return yt.promise.get( this )
                .then( t )
        }, Ze.prototype.finally = function( t )
        {
            return yt.promise.get( this )
                .finally( t )
        }, c( Ze.prototype, Ye ), c( Ze, Yt ), Object.keys( Ye )
        .forEach( function( e )
        {
            Ze[ e ] = function( )
            {
        ...
        } ), Ze.DismissReason = _, Ze.version = "9.3.16";
    var Qe = Ze;
